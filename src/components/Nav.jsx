...
const Nav = ({ user }) => {
  return (
    <nav className="flex flex-col justify-between items-end p-2 py-4 max-sm:col-span-1">
      <div>
        {/* logo */}
        <img className="w-14 mb-4" src="https://cdn1.img.sputniknews.com.tr/img/07e7/07/18/1073897068_140:0:516:376_1920x0_80_0_0_e2cb63a4c6bc513119a800c895ab51ba.png" />
